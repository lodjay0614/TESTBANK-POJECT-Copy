...
export default function Authenticated({ auth, user, header, children }) {
    ...
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
            <nav
                className=" dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700"
                style={{ backgroundColor: "#77060a" }}
            >
                        ...
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <div className="dropdown-menu dropdown-menu-end">
                                        <a className="dropdown-item" href={route("exampage")}>List</a>
                                        <a className="dropdown-item" href={route("exampage_pending")}>Pending</a>
                                        <a className="dropdown-item" href="#">Denied</a>
                                </div>
                            </div>
                        ) : ("")}
                            {user.role === "admin" ? (
